        ...
        <div>
          ...
          <h3>
            <p>
              ...
              .&nbsp;
              <a
                href="https://github.com/14amoore/cook17"
                className="underline"
              >
                Here is the source code if you&apos;d like to see that
              </a>
              , it&apos;s hosted on GitHub. You can listen to prerecorded
              samples of the extension in the Soundcloud player above.
            </p>
          </h3>
          <h1>Why I Made This:</h1>
          <h3>
            <p>
              HTTP cookies are one of the building blocks of the modern
              internet. Cookies come to us from a time when computing memory was
              much more expensive than it is today. They were used to assist
              customers in keeping track of what was in their e-commerce
              shopping carts.
            </p>
            <p>
              ...
              like to buy. The product sold is the data collected by cookies
              about user&apos;s browsing habits.
            </p>
            <p>
              As of now there is very little notification for users as to the
              purpose of the cookies being installed on their computers. The
              sheer number installed on a user&apos;s computer during an average
              browsing session can be staggering, with individual sites
              installing hundreds at a time. The aim of this extension is to use
              sound to alert users about the number, and some of the properties
              of the cookies being installed on user&apos;s computers. This
              extension is inteded to remedie this situation and give users of
              the Internet a new way to understand what, and who is a product on
          ...
          <h3>
            <ol className="list">
              ...
              <li className="instructions">
                The file you downloaded is compressed, so it must be
                decompressed. Double click on the file to do so. (The file most
                likely was placed in your downloads folder after it finished
                downloading, in case you can&apos;t find it.)
              </li>
              <li className="instructions">
              ...
              <li className="instructions">
                In the upper lefthand corner click the button that says
                &quot;Load unpacked&quot;.
              </li>
              <li className="instructions">
              ...
              <li className="instructions">
                ...
                icon with the letter &quot;A&quot;. Quit your browser, restart
                it, and click the &quot;A&quot; icon.
              </li>
