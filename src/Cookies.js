    ...
    <section className="headline">
      ...
      <h3>
        <p>
          ...
          Javascript, HTML, and CSS. I am deeply indebted Yotam Mann for making
          Tone.js. You can checkout his work by{' '}
          <a href="https://yotammann.info/">clicking here</a>. If you&apos;d
          like to see the documentation for Tone.js, please{' '}
          <a href="https://tonejs.github.io/">click here</a>. If you would like
          to see the source code for this project it is in a GitHub repo, please{' '}
          <a href="https://github.com/14amoore/cook17">click here</a>.
        </p>
      </h3>
      ...
      <h3>
        ...
        <p>
          ...
          number installed on a user&apos;s computer during an average browsing
          session can be staggering, with individual sites installing hundreds
          at a time. The aim of this extension is to use sound to alert users
          about the number, and some of the properties of the cookies being
          installed on user&apos;s computers. This extension is inteded to
          remedie this situation and give users of the Internet a new way to
          understand what, and who is a product on the Internet in 2020.
        </p>
      </h3>
      ...
      <h3>
        <ul>
          ...
          <li className="instructions">
            ...
            Double click on the file to do so. (The file most likely was placed
            in your downloads folder after it finished downloading, in case you
            can&apos;t find it.)
          </li>
          <li className="instructions">
          ...
          <li className="instructions">
            Click once on the uncompressed extension. Click &quot;select&quot;.
          </li>
          <li className="instructions">
            In the upper right hand corner of your browser there will be an icon
            with the letter &quot;A&quot;. Quit your browser, restart it, and
            click the &quot;A&quot; icon.
          </li>
