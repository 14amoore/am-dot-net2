...
function Cav() {
  return (
    <section className="projectBody">
      ...
      <h3>
        <p>
          Closet Cav was made using Node.js, Reach Router, Firebase, React, and
          React Bootstrap. Users are authenticated using email and password. I
          chose firebase because it is a realtime database that my partner and I
          can access at the same time, when one of us adds or deletes a bottle
          the other sees these changes happen immediately. I chose react and
          react bootstrap due to their functionality, and popularity within the
      ...
      <h3>
        ...
        <p>
          This app was created for the use my partner and I, and also as a proof
          of concept project to be shown to other members of the food and drink
          industry for further UX research.
        </p>
        <p>
          This project started out with a simple complaint. “Why is it that I
          never know exactly what’s in the back of the closet?” I know this is a
        ...
        <p>
          ...
          <a className="underline" href="https://github.com/14amoore/closetCav">
            here
          </a>
          .
        </p>
